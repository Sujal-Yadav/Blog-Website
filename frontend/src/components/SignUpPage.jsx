        ...
        <div className="h-screen">
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-10 dark:bg-slate-950 border dark:border-slate-800 p-6 rounded-md">
                ...
                <div className="md:grid md:grid-cols-4 gap-4 grid grid-cols-4">
                    ...
                    <div className="md:mt-2 mt-2 md:col-span-2 col-span-2">
                        <button className="text-white bg-blue-700 dark:text-slate-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><Link to='/'>Login</Link></button>
                    </div>
