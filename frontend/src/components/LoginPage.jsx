...
=======
                <div className="flex grid-cols-2 justify-center items-center ml-4">
...
=======
                    <form onSubmit={handleSubmit} className="w-3/6 h-fit mx-8 col-span-1 dark:bg-slate-950 p-6 border dark:border-slate-800 rounded-md">
...
>>>>>>> Stashed changes
                        ...
                        <div className="md:grid md:grid-cols-4 gap-4 grid grid-cols-4">
                            ...
                            <div className="md:my-2 my-4 col-span-4 ">
                                ...
                                <button type="button" onClick={googleLogin} className="text-white dark:text-slate-950 bg-blue-600 hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-md w-full px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
