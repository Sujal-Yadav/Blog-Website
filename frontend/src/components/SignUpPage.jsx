...
export default function SignUpPage() {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-10 bg-slate-950 border border-slate-800 p-6 rounded-md">
                <h2 className="text-4xl font-bold text-gray-900 dark:text-white pb-2">
                    Sign up to Blogsite
                </h2>
                <div className="mb-5">
                ...
                <div className="mb-5">
                    ...
                    <div className="flex">
                        ...
                        {!isVisible ? 
                        <button type="button" onClick={handleVisible} className="border border-border-y border-l rounded-r-lg dark:bg-slate-950 dark:border-slate-800 p-2">
                            ...
                            <button type="button" onClick={handleVisible} className="border border-y border-l rounded-r-lg dark:bg-slate-950 dark:border-slate-800 p-2">
                                <svg className="w-6 h-6 text-slate-700 dark:text-slate-700 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div className="md:grid md:grid-cols-4 gap-4 grid grid-cols-4">
                    ...
                    <div className="md:my-2 my-4 col-span-4">
                        <div className="border-t border-slate-800 pb-6"></div>
